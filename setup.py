...
class BdistSpark(Command):
    ...
    def run(self):
        ...
        os.system("pip --trusted-host pypi.org --trusted-host files.pythonhosted.org wheel -r requirements.txt -w "+self.wheel_dir)  
...
name=PACKAGE_NAME,
    ...
    author='krishna Naredla',

    author_email='krishna.gopala@bcbsnc.com',
